...
/**
 * get_full_name - gets full name of a passed command
 * @name: string
 * @env_list: list of environment variables
 *
 * Return: full name of given command
 *         Otherwise NULL
 */
...
/**
 * get_full_path - checks if a given file is in PATH
...
/**
 * create_path - Concatenates directory name and
 * filename to create full path
 * @dir: directory name
 * @filename: filename
 *
